...
\begin{figure}[h]
\center
    \subfigure[fig-2010][Comunidades $C_0$ (roxo), $C_1$ (marrom), $C_2$ (vermelho), $C_3$ (verde) e $C_4$ (rosa)]{\includegraphics[width=7.5cm]{img/grafos/2010a.png}\label{fig:grafos-2010-a}}
    \qquad
    \subfigure[fig-2010b][Espectro político dos partidos]{\includegraphics[width=7.5cm]{img/grafos/2010c.png}\label{fig:grafos-2010-b}}
...
\begin{figure}[h]
\center
    \subfigure[fig-2014][Comunidades $C_0$ (marrom), $C_1$ (roxo), $C_2$ (rosa) e $C_3$ (verde)]{\includegraphics[width=7.5cm]{img/grafos/2014a.png}\label{fig:grafos-2014-a}}
    \qquad
    \subfigure[fig-2014b][Espectro político dos partidos]{\includegraphics[width=7.5cm]{img/grafos/2014c.png}\label{fig:grafos-2014-b}}
    
    \caption{2014: Comunidades e espectro político}
    \label{fig:grafos-2014}
\end{figure}
...
Ao analisar o gráfico de vértices e arestas (Figura~\ref{fig:grafico-verticesarestas}), percebe-se que embora a quantidade de vértices permaneça quase inalterada (a única exceção é em 1994, com o menor número de partidos, 24), o total de arestas varia consideravelmente.
