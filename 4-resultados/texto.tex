...
\begin{figure}[H]
\center
    \subfigure[fig-1994][Comunidades C0 (vértices rosas) e C1 (vértices verdes)]{\includegraphics[width=7.5cm]{img/grafos/1994a.png}}
    \qquad
...
\begin{figure}[H]
\center
    \subfigure[fig-1998][Comunidades C0 (vértices em laranja) e C1 (vértices verdes)]{\includegraphics[width=7.5cm]{img/grafos/1998a.png}}
    \qquad
...
\toda{Colocamos as legendas das comunidades abaixo da imagem (a) mas nao parece ficar muito bom, onde poderiamos colocar isso? No próprio texto?}
...
\begin{figure}[H]
\center
    \subfigure[fig-2002][Comunidades C0 (vértices em rosa) e C1 (vértices verdes)]{\includegraphics[width=7.5cm]{img/grafos/2002a.png}}
    \qquad
...
\begin{figure}[H]
\center
    \subfigure[fig-2006][Comunidades C0 (vértices em rosa), C1 (vértices verdes) e C2 (vértices cinzas)]{\includegraphics[width=7.5cm]{img/grafos/2006a.png}}
    \qquad
...
\begin{figure}[H]
\center
    \subfigure[fig-2010][Comunidades C0 (roxo), C1 (marrom), C2 (vermelho), C3 (verde) e C4 (rosa)]{\includegraphics[width=7.5cm]{img/grafos/2010a.png}}
    \qquad
...
\toda{Este grafo vai ser corrigido, está com um erro de cor em alguns vértices}
