...
\todo{precisa falar aqui que a gente não precisa entrar em detalhes que explicam exatamente o que é direita x esquerda, ou precisa falar sobre isso de maneira mais específica?}
...
\todo{Faz sentido visualizações estar dentro de conceitos e definições? Parece um pouco esquisito, de repente poderia estar em um novo capítulo}