...
{Prof. Dr. André Luiz Pires Guedes}{Departamento de Informática, UFPR}
{Prof. Dr. Carlos Alberto Maziero}{Departamento de Informática, UFPR}

\defesa{08 de dezembro de 2017}   % dia em que foi realizada a defesa da dissertacao
...
\input{1-intro/texto.tex}
\input{2-fundamentos/texto.tex}
\input{3-proposta/texto.tex}
\input{4-resultados/texto.tex}
\input{99-final/conclusao.tex}
